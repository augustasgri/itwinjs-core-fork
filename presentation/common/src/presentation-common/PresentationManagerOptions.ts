 ...
 * @public
 * @deprecated in 4.x - will not be removed until 2026-06-25. Should never be deprecated. Use [[SingleElementPropertiesRequestOptions]] or [[MultiElementPropertiesRequestOptions]] directly.
 */
 ...
 * @public
 * @deprecated in 5.0 - will not be removed until 2026-06-25. Use `computeSelection` from [@itwin/unified-selection](https://github.com/iTwin/presentation/blob/master/packages/unified-selection/README.md#selection-scopes) package instead.
 */
