...
export interface ItemJSON {
  ...
  /** @deprecated in 5.x - will not be removed until 2026-06-16. Use [[label]] instead. */
...
export class Item {
   ...
   * @deprecated in 5.0 - will not be removed until 2026-06-16. Use an overload with `ItemProps` instead.
   */
  public constructor(
    primaryKeys: InstanceKey[],
