 ...
 * @public
 * @deprecated in 5.0 - will not be removed until 2026-06-16. This is unnecessary after switching to [@itwin/unified-selection](https://github.com/iTwin/presentation/blob/master/packages/unified-selection/README.md)
