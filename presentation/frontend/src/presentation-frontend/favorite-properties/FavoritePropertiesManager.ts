...
export class FavoritePropertiesManager implements Disposable {
   ...
   * @deprecated in 4.5 - will not be removed until 2026-06-16. Initialization is performed automatically by all async methods and only needed for deprecated [[FavoritePropertiesManager.has]] and [[FavoritePropertiesManager.sortFields]].
   */
   ...
   * @deprecated in 4.5 - will not be removed until 2026-06-16. Use [[FavoritePropertiesManager.hasAsync]] instead. This method is not async, therefore it requires early initialization by calling [[FavoritePropertiesManager.initializeConnection]].
   */
   ...
   * @note `initializeConnection` must be called with the `imodel` before calling this function.
   * @deprecated in 4.5 - will not be removed until 2026-06-16. Use [[FavoritePropertiesManager.sortFieldsAsync]] instead. This method is not async, therefore it requires early initialization by calling [[FavoritePropertiesManager.initializeConnection]].
   */
