...
export interface PresentationManagerProps {
   ...
   * is used by default.
   *
   * @deprecated in 4.0 - will not be removed until 2026-06-16. Use [IModelApp.quantityFormatter]($core-frontend) to set the active unit system.
   */
   ...
   *
   * @deprecated in 5.1 - will not be removed until 2026-06-16. [IModelConnection.schemaContext]($core-frontend) is now used by default instead.
   */
...
export class PresentationManager implements Disposable {
   ...
   *
   * @deprecated in 4.0 - will not be removed until 2026-06-16. `IModelApp.quantityFormatter` should be used to get/set the active unit system. At the moment
  ...
  /**
   * Retrieves nodes
   * @deprecated in 4.5 - will not be removed until 2026-06-16. Use [[getNodesIterator]] instead.
   */
   ...
   * @deprecated in 4.5 - will not be removed until 2026-06-16. Use [[getContentIterator]] instead.
   */
   ...
   * @deprecated in 4.5 - will not be removed until 2026-06-16. Use [[getDistinctValuesIterator]] instead.
   */
  ...
  /**
   * Retrieves display label definition of specific items.
   * @deprecated in 4.5 - will not be removed until 2026-06-16. Use [[getDisplayLabelDefinitionsIterator]] instead.
   */
