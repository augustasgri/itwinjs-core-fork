...
export enum PresentationBackendNativeLoggerCategory {
  ...
  /** @deprecated in 4.0 - will not be removed until 2026-06-16. The logging namespace is not used anymore. */
  ECPresentation_Localization = "ECPresentation.Localization",
  /** @deprecated in 4.0 - will not be removed until 2026-06-16. Use [[ECPresentation]] */
  ECPresentation_RulesEngine = "ECPresentation.RulesEngine",
  /** @deprecated in 4.0 - will not be removed until 2026-06-16. Use [[ECPresentation_Content]] */
  ...
  /** @deprecated in 4.0 - will not be removed until 2026-06-16. Use [[ECPresentation_Hierarchies]] */
  ECPresentation_RulesEngine_Navigation = "ECPresentation.Navigation",
  /** @deprecated in 4.0 - will not be removed until 2026-06-16. Use [[ECPresentation_Hierarchies_Cache]] */
  ECPresentation_RulesEngine_Navigation_Cache = "ECPresentation.Navigation.Cache",
  /** @deprecated in 4.0 - will not be removed until 2026-06-16. Use [[ECPresentation_Tasks]] */
  ECPresentation_RulesEngine_Threads = "ECPresentation.Tasks",
  /** @deprecated in 4.0 - will not be removed until 2026-06-16. Use [[ECPresentation_Update]] */
  ECPresentation_RulesEngine_Update = "ECPresentation.Update",
  /** @deprecated in 4.0 - will not be removed until 2026-06-16. Use [[ECPresentation_RulesetVariables]] */
