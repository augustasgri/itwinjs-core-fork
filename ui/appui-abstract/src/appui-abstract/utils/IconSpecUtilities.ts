 ...
 * @public @deprecated in 4.3 - will not be removed until 2026-06-16. AppUI libraries >= 4.7.x support loading SVGs sources without prefixes, eliminating the need for these utilities.
 */
export class IconSpecUtilities {
   ...
   * @public @deprecated in 4.3 - will not be removed until 2026-06-16. AppUI libraries > 4.7.x support loading SVGs sources without prefixes, eliminating the need for this utility.
  */
