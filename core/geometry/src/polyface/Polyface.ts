...
export class IndexedPolyface extends Polyface { // more info can be found at geometry/internaldocs/Polyface.md
  ...
  */
   ...
   * @deprecated in 4.x - will not be removed until 2026-06-16. To remove nebulous "open facet" concept from the API. Call [[PolyfaceData.trimAllIndexArrays]]
   * instead.
   */
   ...
   * @deprecated in 4.x - will not be removed until 2026-06-16. Use [[IndexedPolyface.tryGetFaceData]], which verifies the index is in range.
   */
