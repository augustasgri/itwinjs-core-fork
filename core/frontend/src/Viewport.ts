 ...
 * @see [[ElementLocateManager]]
  */
   ...
   * @deprecated in 5.0 - will not be removed until 2026-06-16. Use [[mapTileTreeRefs]] instead.
   */
   ...
   * @deprecated in 5.0 - will not be removed until 2026-06-16. Use [[getTileTreeRefs]] instead.
   */
  ...
  * @deprecated in 5.0 - will not be removed until 2026-06-16. Use the overload accepting a ReadImageToCanvasOptions.
  */
