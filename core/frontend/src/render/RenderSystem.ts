...
export abstract class RenderSystem implements Disposable {
  ...
  /** @deprecated in 5.0 - will not be removed until 2026-06-16. Will be made protected in a future release. Use [Symbol.dispose] instead. */
...
export namespace RenderSystem {
  ...
  export interface Options {
     ...
     * @public
     * @deprecated in 4.x - will not be removed until 2026-06-16. WebGL 1 is no longer supported.
     */
    useWebGL2?: boolean;
