 ...
 * @public
 * @deprecated in 3.6 - will not be removed until 2026-06-16. The RPC system will be significantly refactored (or replaced) in the future.
 */
...
/** @public @deprecated in 3.6 - will not be removed until 2026-06-16. The RPC system will be significantly refactored (or replaced) in the future. */
