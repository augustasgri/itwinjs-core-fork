...
/** @public @deprecated in 3.x - will not be removed until 2026-06-16. This type was mistakenly made public in the common scope. */
export type BackendReadable = Readable;

/** @public @deprecated in 3.x - will not be removed until 2026-06-16. This type was mistakenly made public in the common scope. */
export type BackendWritable = Writable;

/** @internal @deprecated in 3.x - will not be removed until 2026-06-16. This type was mistakenly made public in the common scope. */
